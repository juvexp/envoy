...
#include "gfe/gfe2/feature_flags.h"
...
using SpdyFramerError = ::gfe_http2::Http2DecoderAdapter::SpdyFramerError;
...
void QuicHttpDecoderAdapter::OnSetting(
  ...
  // TODO: Consider whether to add support for handling unknown SETTINGS
