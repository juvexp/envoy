...
#ifndef GFE_QUIC_HTTP_DECODER_QUIC_HTTP_STRUCTURE_DECODER_H_
#define GFE_QUIC_HTTP_DECODER_QUIC_HTTP_STRUCTURE_DECODER_H_
...
#endif  // GFE_QUIC_HTTP_DECODER_QUIC_HTTP_STRUCTURE_DECODER_H_
