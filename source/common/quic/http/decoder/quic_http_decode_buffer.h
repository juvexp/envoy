...
#ifndef GFE_QUIC_HTTP_DECODER_QUIC_HTTP_DECODE_BUFFER_H_
#define GFE_QUIC_HTTP_DECODER_QUIC_HTTP_DECODE_BUFFER_H_
...
#endif  // GFE_QUIC_HTTP_DECODER_QUIC_HTTP_DECODE_BUFFER_H_
