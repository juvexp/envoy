...
#ifndef GFE_QUIC_TOOLS_QUIC_CLIENT_BASE_H_
#define GFE_QUIC_TOOLS_QUIC_CLIENT_BASE_H_
...
class QuicClientBase {
 ...
 protected:
  ...
  // TODO: Change the connection parameter to take in a
 ...
 private:
  ...
  // connection.
  // TODO: Consider some consistent naming scheme (or other) for member
...
#endif  // GFE_QUIC_TOOLS_QUIC_CLIENT_BASE_H_
