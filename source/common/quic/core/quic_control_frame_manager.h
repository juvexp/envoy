...
#ifndef GFE_QUIC_CORE_QUIC_CONTROL_FRAME_MANAGER_H_
#define GFE_QUIC_CORE_QUIC_CONTROL_FRAME_MANAGER_H_
...
class QUIC_EXPORT_PRIVATE QuicControlFrameManager {
 ...
 private:
  ...
  // TODO: switch to linked_hash_set when chromium supports it. The bool
  // is not used here.
...
#endif  // GFE_QUIC_CORE_QUIC_CONTROL_FRAME_MANAGER_H_
