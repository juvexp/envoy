...
#ifndef GFE_QUIC_CORE_QUIC_RECEIVED_PACKET_MANAGER_H_
#define GFE_QUIC_CORE_QUIC_RECEIVED_PACKET_MANAGER_H_
...
#endif  // GFE_QUIC_CORE_QUIC_RECEIVED_PACKET_MANAGER_H_
