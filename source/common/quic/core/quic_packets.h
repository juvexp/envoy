...
#ifndef GFE_QUIC_CORE_QUIC_PACKETS_H_
#define GFE_QUIC_CORE_QUIC_PACKETS_H_
...
class QUIC_EXPORT_PRIVATE QuicPacket : public QuicData {
 public:
  // TODO: 3 fields from header are passed in as arguments.
...
// TODO: Maybe delete retransmittable_frames too?
typedef std::unique_ptr<SerializedPacket, SerializedPacketDeleter>
    OwningSerializedPacketPointer;

}  // namespace gfe_quic

#endif  // GFE_QUIC_CORE_QUIC_PACKETS_H_
