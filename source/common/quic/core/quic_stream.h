...
#ifndef GFE_QUIC_CORE_QUIC_STREAM_H_
#define GFE_QUIC_CORE_QUIC_STREAM_H_
...
class QUIC_EXPORT_PRIVATE QuicStream {
 public:
  ...
  static const gfe_spdy::SpdyPriority kDefaultPriority = 3;
  static_assert(kDefaultPriority == (gfe_spdy::kV3LowestPriority +
                                     gfe_spdy::kV3HighestPriority) /
                                        2,
  ...
  gfe_spdy::SpdyPriority priority() const;

  // Sets priority_ to priority.  This should only be called before bytes are
  // written to the server.
  void SetPriority(gfe_spdy::SpdyPriority priority);
  ...
  // Used in Chrome.
  ABSL_ATTRIBUTE_UNUSED int num_frames_received() const;
  ABSL_ATTRIBUTE_UNUSED int num_duplicate_frames_received() const;
  ...
  // TODO: There should be machinery to send a RST_STREAM/NO_ERROR and
 ...
 protected:
  ...
  // TODO: Let WritevData return boolean.
 ...
 private:
  ...
  // Write buffered data in send buffer. TODO: Consider combine
...
#endif  // GFE_QUIC_CORE_QUIC_STREAM_H_
