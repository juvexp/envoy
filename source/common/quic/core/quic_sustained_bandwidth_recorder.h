...
#ifndef GFE_QUIC_CORE_QUIC_SUSTAINED_BANDWIDTH_RECORDER_H_
#define GFE_QUIC_CORE_QUIC_SUSTAINED_BANDWIDTH_RECORDER_H_
...
#endif  // GFE_QUIC_CORE_QUIC_SUSTAINED_BANDWIDTH_RECORDER_H_
