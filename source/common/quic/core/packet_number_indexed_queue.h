...
#ifndef GFE_QUIC_CORE_PACKET_NUMBER_INDEXED_QUEUE_H_
#define GFE_QUIC_CORE_PACKET_NUMBER_INDEXED_QUEUE_H_
...
#endif  // GFE_QUIC_CORE_PACKET_NUMBER_INDEXED_QUEUE_H_
