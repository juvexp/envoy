...
#ifndef GFE_QUIC_CORE_QUIC_FRAMER_H_
#define GFE_QUIC_CORE_QUIC_FRAMER_H_
...
class QUIC_EXPORT_PRIVATE QuicFramer {
 ...
 private:
  ...
  // owned. TODO: Consider add data producer to framer's constructor.
  QuicStreamFrameDataProducer* data_producer_;

  // Latched value of gfe2_reloadable_flag_quic_use_incremental_ack_processing3.
...
#endif  // GFE_QUIC_CORE_QUIC_FRAMER_H_
