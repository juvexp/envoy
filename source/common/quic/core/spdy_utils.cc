...
#include "common/quic/platform/api/quic_url_utils.h"
...
bool SpdyUtils::CopyAndValidateTrailers(const QuicHeaderList& header_list,
  ...
  // TODO: Check for other forbidden keys, following the HTTP/2 spec.
...
QuicString SpdyUtils::GetPromisedHostNameFromHeaders(
    const SpdyHeaderBlock& headers) {
  // TODO: Consider just checking out the value of the ":authority" key
  // in headers.
