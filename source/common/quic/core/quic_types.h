...
#ifndef GFE_QUIC_CORE_QUIC_TYPES_H_
#define GFE_QUIC_CORE_QUIC_TYPES_H_
...
// TODO: see if WriteStatus can be replaced by QuicAsyncStatus.
enum WriteStatus {
  WRITE_STATUS_OK,
...
enum QuicPacketNumberLength : int8_t {
  ...
  // TODO: Remove this when we remove QUIC_VERSION_39.
...
#endif  // GFE_QUIC_CORE_QUIC_TYPES_H_
