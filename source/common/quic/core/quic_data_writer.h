...
#ifndef GFE_QUIC_CORE_QUIC_DATA_WRITER_H_
#define GFE_QUIC_CORE_QUIC_DATA_WRITER_H_
...
class QUIC_EXPORT_PRIVATE QuicDataWriter {
 public:
  ...
  // TODO: Remove this method and use WriteUInt64() once deprecating
  // gfe2_restart_flag_quic_rw_cid_in_big_endian and QuicDataWriter has a mode
...
#endif  // GFE_QUIC_CORE_QUIC_DATA_WRITER_H_
