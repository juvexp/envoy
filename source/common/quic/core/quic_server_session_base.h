...
#ifndef GFE_QUIC_CORE_QUIC_SERVER_SESSION_BASE_H_
#define GFE_QUIC_CORE_QUIC_SERVER_SESSION_BASE_H_
...
namespace gfe2 {
namespace test {
class GfeQuicServerSessionPeer;
}  // namespace test
}  // namespace gfe2
...
class QUIC_EXPORT_PRIVATE QuicServerSessionBase : public QuicSpdySession {
 ...
 private:
  ...
  friend class gfe2::test::GfeQuicServerSessionPeer;
  ...
  // stored in CachedNetworkParameters.  TODO: This function
...
#endif  // GFE_QUIC_CORE_QUIC_SERVER_SESSION_BASE_H_
