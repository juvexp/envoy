...
QuicConfig::QuicConfig()
  ...
  if (do_not_use_mspc_) {
    QUIC_FLAG_COUNT(gfe2_reloadable_flag_quic_no_mspc);
  }
  SetDefaults();
}
...
// TODO Use this for silent close on mobile, or delete.
...
bool QuicConfig::negotiated() const {
  // TODO: Add the negotiated parameters once and iterate over all
