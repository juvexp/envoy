...
#ifndef GFE_QUIC_CORE_QUIC_PROCESS_PACKET_INTERFACE_H_
#define GFE_QUIC_CORE_QUIC_PROCESS_PACKET_INTERFACE_H_
...
#endif  // GFE_QUIC_CORE_QUIC_PROCESS_PACKET_INTERFACE_H_
