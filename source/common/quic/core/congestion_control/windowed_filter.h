...
#ifndef GFE_QUIC_CORE_CONGESTION_CONTROL_WINDOWED_FILTER_H_
#define GFE_QUIC_CORE_CONGESTION_CONTROL_WINDOWED_FILTER_H_
...
#endif  // GFE_QUIC_CORE_CONGESTION_CONTROL_WINDOWED_FILTER_H_
