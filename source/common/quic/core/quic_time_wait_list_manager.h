...
#ifndef GFE_QUIC_CORE_QUIC_TIME_WAIT_LIST_MANAGER_H_
#define GFE_QUIC_CORE_QUIC_TIME_WAIT_LIST_MANAGER_H_
...
#endif  // GFE_QUIC_CORE_QUIC_TIME_WAIT_LIST_MANAGER_H_
