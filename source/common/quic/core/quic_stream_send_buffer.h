...
#ifndef GFE_QUIC_CORE_QUIC_STREAM_SEND_BUFFER_H_
#define GFE_QUIC_CORE_QUIC_STREAM_SEND_BUFFER_H_
...
class QUIC_EXPORT_PRIVATE QuicStreamSendBuffer {
 ...
 private:
  ...
  // place to write.
  // TODO: inline this method into WriteStreamData() after
  // gfe2_reloadable_flag_quic_use_write_index is deprecated.
  ...
  // Latched value of gfe2_reloadable_flag_quic_stream_send_buffer_write_index.
  const bool use_write_index_;

  // Latched value of gfe2_reloadable_flag_quic_free_mem_slice_out_of_order.
  const bool free_mem_slice_out_of_order_;

  // Latched value of gfe2_reloadable_flag_quic_free_mem_slice_out_of_order and
  // gfe2_reloadable_flag_quic_fast_path_on_stream_data_acked.
  const bool enable_fast_path_on_data_acked_;
};

}  // namespace gfe_quic

#endif  // GFE_QUIC_CORE_QUIC_STREAM_SEND_BUFFER_H_
