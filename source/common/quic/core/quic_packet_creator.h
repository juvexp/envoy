...
#ifndef GFE_QUIC_CORE_QUIC_PACKET_CREATOR_H_
#define GFE_QUIC_CORE_QUIC_PACKET_CREATOR_H_
...
class QUIC_EXPORT_PRIVATE QuicPacketCreator {
 public:
  ...
  // TODO: Directly set packet number length instead of compute it in
  // creator.
 ...
 private:
  ...
  // TODO: Move packet_size_ into SerializedPacket once
...
#endif  // GFE_QUIC_CORE_QUIC_PACKET_CREATOR_H_
