...
#ifndef GFE_QUIC_CORE_QUIC_SPDY_STREAM_H_
#define GFE_QUIC_CORE_QUIC_SPDY_STREAM_H_
...
class QUIC_EXPORT_PRIVATE QuicSpdyStream : public QuicStream {
 public:
  ...
  virtual void OnStreamHeadersPriority(gfe_spdy::SpdyPriority priority);
  ...
  void OnPriorityFrame(gfe_spdy::SpdyPriority priority);
  ...
  // code to |status_code|.
  bool ParseHeaderStatusCode(const gfe_spdy::SpdyHeaderBlock& header,
  ...
  const gfe_spdy::SpdyHeaderBlock& received_trailers() const {
 ...
 private:
  ...
  gfe_spdy::SpdyHeaderBlock received_trailers_;
...
#endif  // GFE_QUIC_CORE_QUIC_SPDY_STREAM_H_
