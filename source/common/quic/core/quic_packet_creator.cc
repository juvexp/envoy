...
void QuicPacketCreator::CreateAndSerializeStreamFrame(
  ...
  // TODO: AppendTypeByte and AppendStreamFrame could be optimized
  ...
  // TODO: Optimize the storage so RetransmitableFrames can be
...
// TODO: Make this a public method of framer?
