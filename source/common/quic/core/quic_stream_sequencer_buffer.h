...
#ifndef GFE_QUIC_CORE_QUIC_STREAM_SEQUENCER_BUFFER_H_
#define GFE_QUIC_CORE_QUIC_STREAM_SEQUENCER_BUFFER_H_
...
#endif  // GFE_QUIC_CORE_QUIC_STREAM_SEQUENCER_BUFFER_H_
