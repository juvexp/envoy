...
#ifndef GFE_QUIC_CORE_FRAMES_QUIC_PATH_CHALLENGE_FRAME_H_
#define GFE_QUIC_CORE_FRAMES_QUIC_PATH_CHALLENGE_FRAME_H_
...
#endif  // GFE_QUIC_CORE_FRAMES_QUIC_PATH_CHALLENGE_FRAME_H_
