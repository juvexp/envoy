...
#ifndef GFE_QUIC_CORE_QUIC_CONFIG_H_
#define GFE_QUIC_CORE_QUIC_CONFIG_H_
...
class QUIC_EXPORT_PRIVATE QuicNegotiableUint32 : public QuicNegotiableValue {
  // TODO: some negotiated values use uint32 as bool (e.g., silent
...
class QUIC_EXPORT_PRIVATE QuicConfig {
 public:
  ...
  // connection option.
  // TODO: Rename to HasClientRequestedSharedOption
...
#endif  // GFE_QUIC_CORE_QUIC_CONFIG_H_
