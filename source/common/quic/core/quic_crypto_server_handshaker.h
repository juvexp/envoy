...
#ifndef GFE_QUIC_CORE_QUIC_CRYPTO_SERVER_HANDSHAKER_H_
#define GFE_QUIC_CORE_QUIC_CRYPTO_SERVER_HANDSHAKER_H_
...
#endif  // GFE_QUIC_CORE_QUIC_CRYPTO_SERVER_HANDSHAKER_H_
