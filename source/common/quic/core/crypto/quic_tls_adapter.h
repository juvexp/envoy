...
#ifndef GFE_QUIC_CORE_CRYPTO_QUIC_TLS_ADAPTER_H_
#define GFE_QUIC_CORE_CRYPTO_QUIC_TLS_ADAPTER_H_

#include "common/quic/core/crypto/crypto_message_parser.h"
...
#endif  // GFE_QUIC_CORE_CRYPTO_QUIC_TLS_ADAPTER_H_
