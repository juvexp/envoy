...
#ifndef GFE_QUIC_CORE_CRYPTO_AES_128_GCM_ENCRYPTER_H_
#define GFE_QUIC_CORE_CRYPTO_AES_128_GCM_ENCRYPTER_H_
...
#endif  // GFE_QUIC_CORE_CRYPTO_AES_128_GCM_ENCRYPTER_H_
