...
#include "common/quic/core/crypto/ephemeral_key_source.h"
...
// TODO: Reduce this to 2 again once b/25933682 is fixed.
...
HandshakeFailureReason QuicCryptoServerConfig::ParseSourceAddressToken(
  ...
  if (!tokens->ParseFromArray(plaintext.data(), plaintext.size())) {
    ...
    // TODO: remove this code once the new format is ubiquitous.
