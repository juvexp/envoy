...
#ifndef GFE_QUIC_CORE_CRYPTO_CRYPTO_PROTOCOL_H_
#define GFE_QUIC_CORE_CRYPTO_CRYPTO_PROTOCOL_H_
...
const QuicTag kLFAK = TAG('L', 'F', 'A', 'K');   // Don't invoke FACK on the
                                                 // first ack.
// TODO: Remove this connection option in QUIC_VERSION_37, in which
...
#endif  // GFE_QUIC_CORE_CRYPTO_CRYPTO_PROTOCOL_H_
