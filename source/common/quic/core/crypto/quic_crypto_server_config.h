...
#ifndef GFE_QUIC_CORE_CRYPTO_QUIC_CRYPTO_SERVER_CONFIG_H_
#define GFE_QUIC_CORE_CRYPTO_QUIC_CRYPTO_SERVER_CONFIG_H_
...
#include "common/quic/core/proto/source_address_token.proto.h"
...
// TODO: when adding configurations at runtime is added, this object will
 ...
 private:
  ...
  class QUIC_EXPORT_PRIVATE Config : public QuicCryptoConfig,
   ...
   public:
    ...
    // TODO: since this is a class, we should probably do
...
#endif  // GFE_QUIC_CORE_CRYPTO_QUIC_CRYPTO_SERVER_CONFIG_H_
