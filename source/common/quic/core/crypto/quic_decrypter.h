...
#ifndef GFE_QUIC_CORE_CRYPTO_QUIC_DECRYPTER_H_
#define GFE_QUIC_CORE_CRYPTO_QUIC_DECRYPTER_H_
...
class QUIC_EXPORT_PRIVATE QuicDecrypter {
 public:
  ...
  // to form the nonce.
  // TODO: add a way for DecryptPacket to report decryption failure due
...
#endif  // GFE_QUIC_CORE_CRYPTO_QUIC_DECRYPTER_H_
