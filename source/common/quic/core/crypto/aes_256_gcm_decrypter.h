...
#ifndef GFE_QUIC_CORE_CRYPTO_AES_256_GCM_DECRYPTER_H_
#define GFE_QUIC_CORE_CRYPTO_AES_256_GCM_DECRYPTER_H_
...
#endif  // GFE_QUIC_CORE_CRYPTO_AES_256_GCM_DECRYPTER_H_
