...
#ifndef GFE_QUIC_CORE_CRYPTO_CRYPTO_HANDSHAKE_MESSAGE_H_
#define GFE_QUIC_CORE_CRYPTO_CRYPTO_HANDSHAKE_MESSAGE_H_
...
#endif  // GFE_QUIC_CORE_CRYPTO_CRYPTO_HANDSHAKE_MESSAGE_H_
