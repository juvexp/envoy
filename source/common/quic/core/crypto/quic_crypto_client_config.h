...
#ifndef GFE_QUIC_CORE_CRYPTO_QUIC_CRYPTO_CLIENT_CONFIG_H_
#define GFE_QUIC_CORE_CRYPTO_QUIC_CRYPTO_CLIENT_CONFIG_H_
 ...
 public:
  ...
  class QUIC_EXPORT_PRIVATE CachedState {
   ...
   private:
    ...
    // TODO: Consider using a hash-set as extra book-keeping to ensure
...
#endif  // GFE_QUIC_CORE_CRYPTO_QUIC_CRYPTO_CLIENT_CONFIG_H_
