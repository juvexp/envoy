...
#ifndef GFE_QUIC_CORE_QUIC_SIMPLE_BUFFER_ALLOCATOR_H_
#define GFE_QUIC_CORE_QUIC_SIMPLE_BUFFER_ALLOCATOR_H_
...
#endif  // GFE_QUIC_CORE_QUIC_SIMPLE_BUFFER_ALLOCATOR_H_
