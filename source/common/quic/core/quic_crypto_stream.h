...
#ifndef GFE_QUIC_CORE_QUIC_CRYPTO_STREAM_H_
#define GFE_QUIC_CORE_QUIC_CRYPTO_STREAM_H_
...
class QUIC_EXPORT_PRIVATE QuicCryptoStream : public QuicStream {
 ...
 private:
  ...
  // TODO: This is not needed once switching from QUIC crypto to
...
#endif  // GFE_QUIC_CORE_QUIC_CRYPTO_STREAM_H_
