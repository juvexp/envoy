...
#ifndef GFE_QUIC_PLATFORM_API_QUIC_ALIGNED_H_
#define GFE_QUIC_PLATFORM_API_QUIC_ALIGNED_H_

#include "common/quic/platform/impl/quic_aligned_impl.h"
...
#endif  // GFE_QUIC_PLATFORM_API_QUIC_ALIGNED_H_
