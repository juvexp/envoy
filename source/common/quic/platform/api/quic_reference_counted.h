...
#ifndef GFE_QUIC_PLATFORM_API_QUIC_REFERENCE_COUNTED_H_
#define GFE_QUIC_PLATFORM_API_QUIC_REFERENCE_COUNTED_H_

#include "common/quic/platform/impl/quic_reference_counted_impl.h"
...
#endif  // GFE_QUIC_PLATFORM_API_QUIC_REFERENCE_COUNTED_H_
