...
#ifndef GFE_QUIC_PLATFORM_API_QUIC_FLAGS_H_
#define GFE_QUIC_PLATFORM_API_QUIC_FLAGS_H_

#include "common/quic/platform/impl/quic_flags_impl.h"
...
#endif  // GFE_QUIC_PLATFORM_API_QUIC_FLAGS_H_
