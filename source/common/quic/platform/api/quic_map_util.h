...
#ifndef GFE_QUIC_PLATFORM_API_QUIC_MAP_UTIL_H_
#define GFE_QUIC_PLATFORM_API_QUIC_MAP_UTIL_H_

#include "common/quic/platform/impl/quic_map_util_impl.h"
...
#endif  // GFE_QUIC_PLATFORM_API_QUIC_MAP_UTIL_H_
