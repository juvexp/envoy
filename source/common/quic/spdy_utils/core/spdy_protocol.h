...
#ifndef GFE_SPDY_CORE_SPDY_PROTOCOL_H_
#define GFE_SPDY_CORE_SPDY_PROTOCOL_H_
...
enum class SpdyFrameType : uint8_t {
  ...
  // extension API.
  // TODO: Remove the fake EXTENSION value from the SpdyFrameType
  // enum.
  EXTENSION = 0xff
};
...
class SPDY_EXPORT_PRIVATE SpdyGoAwayIR : public SpdyFrameIR {
 public:
  ...
  void set_error_code(SpdyErrorCode error_code) {
    // TODO: Check valid ranges of error_code?
...
#endif  // GFE_SPDY_CORE_SPDY_PROTOCOL_H_
