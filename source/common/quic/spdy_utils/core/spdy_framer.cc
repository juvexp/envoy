...
// TODO: remove all the down_casts.
...
// TODO: Use also in frame serialization.
class FlagsSerializationVisitor : public SpdyFrameVisitor {
 public:
  ...
  // TODO: The END_HEADERS flag is incorrect for HEADERS that require
  //     CONTINUATION frames.
  void VisitHeaders(const SpdyHeadersIR& headers) override {
  ...
  // TODO: The END_PUSH_PROMISE flag is incorrect for PUSH_PROMISEs
  ...
  // TODO: The END_HEADERS flag is incorrect for CONTINUATIONs that
