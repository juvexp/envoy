...
#ifndef GFE_SPDY_CORE_SPDY_HEADER_BLOCK_H_
#define GFE_SPDY_CORE_SPDY_HEADER_BLOCK_H_
...
//
// This class was inspired by gfe2::BalsaHeaders.
class SPDY_EXPORT_PRIVATE SpdyHeaderBlock {
 private:
  ...
  typedef linked_hash_map<SpdyStringPiece, HeaderValue> MapType;
...
#endif  // GFE_SPDY_CORE_SPDY_HEADER_BLOCK_H_
