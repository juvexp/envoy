...
#ifndef GFE_SPDY_CORE_HTTP2_FRAME_DECODER_ADAPTER_H_
#define GFE_SPDY_CORE_HTTP2_FRAME_DECODER_ADAPTER_H_
...
// TODO: Perform various renames/moves suggested in cl/164660364.

namespace gfe_http2 {

// Adapts SpdyFramer interface to use Http2FrameDecoder.
class SPDY_EXPORT_PRIVATE Http2DecoderAdapter
    : public gfe_http2::Http2FrameDecoderListener {
 public:
  // HTTP2 states.
  enum SpdyState {
    SPDY_ERROR,
...
class SPDY_EXPORT_PRIVATE SpdyFramerVisitorInterface {
 public:
  ...
  virtual void OnError(
      gfe_http2::Http2DecoderAdapter::SpdyFramerError error) = 0;
  ...
  // validated.
  // TODO: Remove with deprecation of
...
#endif  // GFE_SPDY_CORE_HTTP2_FRAME_DECODER_ADAPTER_H_
