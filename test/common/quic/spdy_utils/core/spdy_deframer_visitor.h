...
#ifndef GFE_SPDY_CORE_SPDY_DEFRAMER_VISITOR_H_
#define GFE_SPDY_CORE_SPDY_DEFRAMER_VISITOR_H_
...
class SpdyDeframerVisitorInterface {
 public:
  ...
  virtual void OnError(gfe_http2::Http2DecoderAdapter::SpdyFramerError error,
...
#endif  // GFE_SPDY_CORE_SPDY_DEFRAMER_VISITOR_H_
