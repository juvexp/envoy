...
#include "gfe/http2/hpack/decoder/hpack_decoder_state.h"
#include "gfe/http2/hpack/decoder/hpack_decoder_tables.h"
#include "gfe/http2/hpack/tools/hpack_block_builder.h"
...
using ::gfe_http2::HpackString;
using ::gfe_http2::HpackStringPair;
using ::gfe_http2::test::HpackBlockBuilder;
...
using ::gfe_http2::test::HpackDecoderPeer;
...
class HpackDecoderAdapterPeer {
 public:
  ...
  gfe_http2::HpackDecoderTables* GetDecoderTables() {
...
TEST_P(HpackDecoderAdapterTest, LiteralHeaderNoIndexing) {
  ...
  const SpdyHeaderBlock& header_set = DecodeBlockExpectingSuccess(
      SpdyStringPiece(input, ABSL_ARRAYSIZE(input) - 1));
...
TEST_P(HpackDecoderAdapterTest, SectionC4RequestHuffmanExamples) {
  // TODO: Use gfe/http2/hpack/tools/hpack_example.h to parse the
