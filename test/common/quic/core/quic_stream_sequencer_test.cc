...
// TODO: reorder these tests so they build on each other.
...
// TODO: Figure out the way to implement this test case without the use
// of unsupported QuicStringPiece constructor.
#if 0
TEST_F(QuicStreamSequencerTest, OnStreamFrameWithNullSource) {
  ...
  QuicStringPiece source(nullptr, 5u);
  QuicStreamFrame frame(kGetNthClientInitiatedStreamId1, false, 1, source);
