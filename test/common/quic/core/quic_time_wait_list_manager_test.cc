...
using gfe2::test::FakeTimeEpollServer;
using testing::_;
using testing::Args;
...
class MockFakeTimeEpollServer : public FakeTimeEpollServer {
 public:
  ...
  MOCK_METHOD2(RegisterAlarm,
               void(int64 /* allow-non-std-int */ timeout_in_us,
                    gfe2::EpollAlarmCallbackInterface* alarm));
};
...
class QuicTimeWaitListManagerTest : public QuicTest {
 protected:
  ...
  QuicEncryptedPacket* ConstructEncryptedPacket(
    ...
    return gfe_quic::test::ConstructEncryptedPacket(connection_id, false, false,
                                                    packet_number, "data");
  }
