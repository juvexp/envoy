...
#include "test/common/quic/test_tools/quic_crypto_server_config_peer.h"
...
class QuicDispatcherTest : public QuicTest {
 public:
  ...
  ~QuicDispatcherTest() override { eps_.Shutdown(); }
  ...
  void SetUp() override {
    ...
    CryptoHandshakeMessage chlo =
        crypto_test_utils::GenerateDefaultInchoateCHLO(clock_, version,
                                                       &crypto_config_);
    chlo.SetVector(gfe_quic::kCOPT, gfe_quic::QuicTagVector{gfe_quic::kSREJ});
 ...
 public:
  ...
  void SetUp() override {
    ...
    chlo_ = crypto_test_utils::GenerateDefaultInchoateCHLO(clock_, version,
                                                           &crypto_config_);
    chlo_.SetVector(gfe_quic::kCOPT, gfe_quic::QuicTagVector{gfe_quic::kSREJ});
