...
#ifndef GFE_QUIC_HTTP_TOOLS_QUIC_HTTP_RANDOM_DECODER_TEST_H_
#define GFE_QUIC_HTTP_TOOLS_QUIC_HTTP_RANDOM_DECODER_TEST_H_
...
// TODO: Move more methods into .cc file.
...
#include "test/common/quic/http/tools/quic_http_gunit_helpers.h"  // IWYU pragma: export
...
class QuicHttpRandomDecoderTest : public QuicTest {
 ...
 protected:
  ...
  // TODO: Modify StartDecoding, etc. to (somehow) return
  ...
  virtual bool StopDecodeOnDone() { return stop_decode_on_done_; }
  ...
  // TODO: Replace this overload with the next, as using this method
...
#endif  // GFE_QUIC_HTTP_TOOLS_QUIC_HTTP_RANDOM_DECODER_TEST_H_
