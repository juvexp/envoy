...
#ifndef GFE_QUIC_TEST_TOOLS_QUIC_PACKET_GENERATOR_PEER_H_
#define GFE_QUIC_TEST_TOOLS_QUIC_PACKET_GENERATOR_PEER_H_
...
#endif  // GFE_QUIC_TEST_TOOLS_QUIC_PACKET_GENERATOR_PEER_H_
