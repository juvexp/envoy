...
#ifndef GFE_QUIC_TEST_TOOLS_QUIC_TEST_UTILS_H_
#define GFE_QUIC_TEST_TOOLS_QUIC_TEST_UTILS_H_
...
#include "common/quic/core/congestion_control/loss_detection_interface.h"
...
#include "common/quic/core/quic_connection_close_delegate_interface.h"
...
#define EXPECT_QUIC_BUG EXPECT_GFE_BUG
...
// Upper limit on versions we support.
// TODO: Remove this function when it is no longer used.
...
// Compute SHA-1 hash of the supplied string.
...
class MockQuicSession : public QuicSession {
 public:
  ...
  MOCK_METHOD2(OnStreamHeadersPriority,
               void(QuicStreamId stream_id, gfe_spdy::SpdyPriority priority));
...
class MockQuicSpdySession : public QuicSpdySession {
 public:
  ...
  QuicCryptoStream* GetMutableCryptoStream() override;
  const QuicCryptoStream* GetCryptoStream() const override;
  const gfe_spdy::SpdyHeaderBlock& GetWriteHeaders() { return write_headers_; }
  ...
  MOCK_METHOD2(OnPriorityFrame,
               void(QuicStreamId id, gfe_spdy::SpdyPriority priority));
 ...
 private:
  std::unique_ptr<QuicCryptoStream> crypto_stream_;
  gfe_spdy::SpdyHeaderBlock write_headers_;
...
class TestQuicSpdyClientSession : public QuicSpdyClientSessionBase {
 public:
  ...
  bool IsAuthorized(const string& authority) override;
...
class MockSendAlgorithm : public SendAlgorithmInterface {
 public:
  ...
  MOCK_CONST_METHOD0(GetDebugState, string());
...
#endif  // GFE_QUIC_TEST_TOOLS_QUIC_TEST_UTILS_H_
