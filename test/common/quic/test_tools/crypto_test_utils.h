...
#ifndef GFE_QUIC_TEST_TOOLS_CRYPTO_TEST_UTILS_H_
#define GFE_QUIC_TEST_TOOLS_CRYPTO_TEST_UTILS_H_
...
class TestChannelIDKey : public ChannelIDKey {
 public:
  ...
  bool Sign(QuicStringPiece signed_data, string* out_signature) const override;
...
#endif  // GFE_QUIC_TEST_TOOLS_CRYPTO_TEST_UTILS_H_
