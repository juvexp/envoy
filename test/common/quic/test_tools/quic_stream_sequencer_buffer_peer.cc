...
typedef gfe_quic::QuicStreamSequencerBuffer::BufferBlock BufferBlock;
typedef gfe_quic::QuicStreamSequencerBuffer::FrameInfo FrameInfo;
typedef gfe_quic::QuicStreamSequencerBuffer::Gap Gap;

static const size_t kBlockSizeBytes =
    gfe_quic::QuicStreamSequencerBuffer::kBlockSizeBytes;
