...
#ifndef GFE_QUIC_TEST_TOOLS_SIMULATOR_QUIC_ENDPOINT_H_
#define GFE_QUIC_TEST_TOOLS_SIMULATOR_QUIC_ENDPOINT_H_
...
#include "test/common/quic/test_tools/simple_session_notifier.h"
...
class QuicEndpointMultiplexer : public Endpoint,
                                public UnconstrainedPortInterface {
 public:
  QuicEndpointMultiplexer(string name,
 ...
 private:
  QuicUnorderedMap<string, QuicEndpoint*> mapping_;
};

}  // namespace simulator
}  // namespace gfe_quic

#endif  // GFE_QUIC_TEST_TOOLS_SIMULATOR_QUIC_ENDPOINT_H_
