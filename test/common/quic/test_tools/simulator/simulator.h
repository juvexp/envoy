...
#ifndef GFE_QUIC_TEST_TOOLS_SIMULATOR_SIMULATOR_H_
#define GFE_QUIC_TEST_TOOLS_SIMULATOR_SIMULATOR_H_
...
class Simulator : public QuicConnectionHelperInterface {
 ...
 private:
  ...
  QuicUnorderedSet<string> actor_names_;
...
#endif  // GFE_QUIC_TEST_TOOLS_SIMULATOR_SIMULATOR_H_
